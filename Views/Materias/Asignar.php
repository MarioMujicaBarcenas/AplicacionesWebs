<div class="row bg-light text-dark mx-auto col-md-10" >
  ...
  <div class="col-md-6">
    <form id="regusr" class="form-signin" action="<?php echo URL ?>login/guardar" method="post">
      <br>
      <h1 class=" font-weight-normal">Asignar Materias</h1>
        ...
        <div class="col-md-12 form-group">
          <label for="id_sexo">Profesor</label>
          <select class="form-control" name="id_sexo">
            <option value="">Selecciona...</option>
            <?php
            if(isset($datos[0])){
      ...
      <br>
      <button type="submit" class="btn btn-lg btn btn-outline-success btn-block">Asignar</button>
      <br>
      <br>
    </form>
  </div>
